...
// Power                              
const int BATTERY_VOLTAGE_PIN = A7;   // ADC7  input   10-bit ADC (?? same as PC7??)
const int CHARGE_CURRENT_PIN = A6;    // ACD6  input   10-bit ADC (?? same as PC6??)
...
const int BATTERY_LED_MED_PIN = A1;   // PC1   output  Digital: LOW = on, HIGH = off
